...
//------------------------------------------------- Ergänzungen Modrow -------------------------------
        menu.addItem(
            'Load SQLsnap',
            function() {
                window.open('http://snapextensions.uni-goettingen.de/SQLsnap.zip', 'SQLsnap source'
                        );
            }
    );
    menu.addItem(
            'SQLsnap-manual',
            function() {
                window.open('http://snapextensions.uni-goettingen.de/sqlsnapmanual.pdf',
                        'SQLsnap manual'
                        );
            }
    );
    menu.addItem(
            'example: galaxy',
            function() {
                window.open('http://snapextensions.uni-goettingen.de/galaxy.xml',
                        'galaxy.xml'
                        );
            }
    );
    menu.addItem(
            'example: ciphertext',
            function() {
                window.open('http://snapextensions.uni-goettingen.de/ciphertext.xml',
                        'ciphertext'
                        );
            }
    );
