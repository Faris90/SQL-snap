...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo = new Morph();
    this.logo.texture = 'sqlsnaplogo.png';
...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem(
        'Load SQLsnap',
        function () {
            window.open('http://snapextensions.uni-goettingen.de/oldSQLsnap.zip','SQLsnap source'
            );
        }
    );
        menu.addItem(
        'SQLsnap-manual',
        function () {window.open('http://snapextensions.uni-goettingen.de/sqlsnapmanual.pdf',
                'SQLsnap manual'
            );
        }
    );
       menu.addItem(
        'example: galaxy',
        function () {window.open('http://snapextensions.uni-goettingen.de/galaxy.xml',
                'galaxy.xml'
            );
        }
    );
       menu.addItem(
        'example: ciphertext',
        function () {window.open('http://snapextensions.uni-goettingen.de/ciphertext.xml',
                'ciphertext'
            );
        }
    );
...
IDE_Morph.prototype.aboutSnap = function () {
    ...
    aboutTxt = 'SQLsnap: a Snap!-variant with little extensions\n\n'
        + 'Copyright \u24B8 2013 Jens M\u00F6nig and '
        + 'Brian Harvey\n'
        + 'jens@moenig.org, bh@cs.berkeley.edu\n\n'
        + 'Copyright for extensions: E. Modrow\n'
